...
public class KafkaChannel extends AbstractChannel {
  ...
  /**
   * Instantiates a new Kafka Channel.
   */
  public KafkaChannel() {
  }
  ...
  public void put(Event event) throws ChannelException {
    getProvider().produceEvent(getName(), event);
  }

  @Override
  public Event take() throws ChannelException {
    return getProvider().consumeEvent(getName());
  }
  ...
  @Override
  public void stop() {
    KafkaChannelProviderFactory.releaseProvider(getName());
    provider = null;

    super.stop();
  }

  private KafkaChannelProvider getProvider() {
    return provider;
  }

  @Override
  public void configure(Context context) {
    provider = KafkaChannelProviderFactory.getProvider(context, getName());

    LOG.info("Kafka Channel initialized: " + getName());
  }
}
